...
if(LANGUAGE_ID == 'en'){
    ...
    $APPLICATION->SetPageProperty("title", 'Buy a cottage, 🏡 cottages for sale in the capital, ads and prices on Fodyo.com');

}else{

    $APPLICATION->SetPageProperty("title", 'Купить коттедж, 🏡 продажа коттеджей (в Москве), объявления и цены на «Fodyo.com»');
}
    ...
    switch ($arParams['VIEW_MODE'])
    {
        ...
        case 'TILE':
            foreach ($arResult['SECTIONS'] as &$arSection)
            {
                    ...
                    <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"><? 
                        if(LANGUAGE_ID == 'en'){
                            ...
                            $getSection = CIBlockSection::GetList(
                                ...
                                false,
                                Array('ID', 'NAME', 'IBLOCK_ID', 'UF_NAME_'.strtoupper(LANGUAGE_ID), 'UF_TEXT_PREVIEW_'.strtoupper(LANGUAGE_ID)),
                                false
                            );
                            while($fetch = $getSection -> GetNext()){
                                print_r($fetch['UF_NAME_'.strtoupper(LANGUAGE_ID)]);
                            }
                        }
                     ?></a>
                     <?
                ...
                while($fetch = $getSection -> GetNext()){
                    print_r($fetch['UF_TEXT_PREVIEW_'.strtoupper(LANGUAGE_ID)]);
                }
                ?>
                </li><?
            }
