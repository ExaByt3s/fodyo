...
$getSection = CIBlockSection::GetList(
    Array("SORT"=>"ASC"),
    Array('ID' => $arResult['VARIABLES']['SECTION_ID'], 'IBLOCK_ID' => 10),
    false,
        ...
        <div class="breadcrumbs">
           <?
            ...
            $getZapas = CIBlockSection::GetList(
                Array("SORT"=>"ASC"),
                Array('IBLOCK_ID' => 10, 'ID' => $arResult['VARIABLES']['SECTION_ID']),
                false,
            ...
            //echo "<pre>"; print_r($exploaded); echo "</pre>";
            if($arResult['VARIABLES']['SECTION_ID'] && $APPLICATION->GetCurDir() == trim('/'.strtolower(LANGUAGE_ID).'-'.$fetchZapas['UF_HREF_ISO'].'/single-family-homes/') ){
                    $arrSection = $fetchZapas;                
            }else{
                foreach ($exploaded as $key => $section_code) {
                    $getList = CIBlockSection::GetList(
                        Array("SORT"=>"ASC"),
                        Array('IBLOCK_ID' => 10, 'CODE' => $section_code),
                        false,
...
//echo "<pre>"; print_r($APPLICATION->GetCurDir()); echo "</pre>";
            ?>
            ...
            <div class="block-title">
                ...
                <span class="huge-title">
                    <?
                    //echo "<pre>"; var_dump(strtoupper($part)); echo "</pre>";
                    ?>
                    <?=GetMessage(strtoupper($part).'_IN_MOSCOW')?><?
                    if(LANGUAGE_ID == 'en'){
            ...
            <?/*if(!stristr($APPLICATION->GetCurDir(), 'flat')){
                ...
                <div class="mini-categories">
                    <a href="<?=str_replace('newbuildings','flat',$APPLICATION->GetCurDir())?>">
                        <div class="flats">
                            <img src="<?=SITE_TEMPLATE_PATH?>/images/flats.png">
                            <div class="category_name"><?=GetMessage('FLATS_MINI')?></div>
                        </div>
                    </a>
                    <a href="<?=str_replace('newbuildings','cottage',$APPLICATION->GetCurDir())?>">
                        <div class="villas">
...
<?if(stristr($APPLICATION->GetCurDir(), 'new-york') && !stristr($APPLICATION->GetCurDir(), 'neighborhoods') && !stristr($APPLICATION->GetCurDir(), 'top-single-family-homes') && !$developerPage && LANGUAGE_ID == 'en'){?>
    <div class="podborki">
        <div class="left">
            <div class="title-podb">Top <span class="orange-text">Boroughs</span></div>
            <div class="table">
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/manhattan/">Single Family Homes Manhattan</a>
                </div>
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/bronx/">Single Family Homes The Bronx</a>
                </div>
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/brooklyn/">Single Family Homes Brooklyn</a>
                </div>
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/queens/">Single Family Homes Queens</a>
                </div>
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/staten-island/">Single Family Homes Staten Island</a>
                </div>
            </div>
        </div>
        <div class="right">
            <div class="title-podb">Top Single Family Homes <span class="orange-text"><?=$arrSection['NAME']?></span></div>
            <div class="table">
                <div class="value">
                    <a href="javascript:void(0);">From Min to $1 000 000</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">From $1 000 001 to $3 000 000</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">From $3 000 001 to $6 000 000</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">From $6 000 001 to $10 000 000</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">From $10 000 001 to Max</a>
                </div>
            </div>
        </div>
    </div>
<?}?>
<?if(stristr($APPLICATION->GetCurDir(), 'usa') && !stristr($APPLICATION->GetCurDir(), 'new-york') && LANGUAGE_ID == 'en'){?>
    <div class="podborki">
        <div class="left">
            <div class="title-podb">Top <span class="orange-text">Simgle Family Homes</span> Locations</div>
            <div class="table">
                <div class="value">
                    <a href="/single-family-homes/usa/new-york/">Single Family Homes New York</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">Single Family Homes Chicago</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">Single Family Homes Los Angeles</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">Single Family Homes Miami</a>
                </div>
                <div class="value">
                    <a href="javascript:void(0);">Single Family Homes Washington, D.C.</a>
                </div>
            </div>
        </div>
        <div class="right">
