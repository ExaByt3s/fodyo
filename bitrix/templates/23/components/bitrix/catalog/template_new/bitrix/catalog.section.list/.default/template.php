...
if(LANGUAGE_ID == 'en'){
    ...
    $APPLICATION->SetPageProperty("title", 'Buy an apartment in a new building, 🏢 apartments for sale in a new building - Fodyo.com portal');

}else{

    $APPLICATION->SetPageProperty("title", 'Новостройки, 🏢 продажа квартир в новом доме - портал Fodyo.com');
}
