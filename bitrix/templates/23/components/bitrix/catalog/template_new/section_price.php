...
<div class="filter">
    <div class="location">
        ...
        <a href="javascript:void(0)" class="on_map"><?=GetMessage('ON_MAP')?></a>
        <a href="javascript:void(0)" class="results"><?=GetMessage('RESULTS')?> <span class="results_num">0</span></a>
    </div>
    <div class="flex-filter" data-section-id='<?=$arResult['VARIABLES']['SECTION_ID']?>' >
        <div class="filter-item">
            ...
            <div class="closed selector">
                <label class="checkbox-new">
                    <input type="checkbox" name="selling_status">
        ...
        <div class="filter-item">
            ...
            <div class="closed selector">
                <label class="checkbox-new">
                    <input type="checkbox" name="housing_type">
        ...
        <div class="filter-item">
            ...
            <div class="closed numerics">
                <div class="text-inputs">
                    <input type="text" name="area_from" placeholder="<?=GetMessage('TEXT_FROM')?>">
                    <input type="text" name="area_to" placeholder="<?=GetMessage('TEXT_TO')?>">
                </div>
            </div>
        </div>
        <div class="filter-item">
        ...
        <div class="filter-item">
            ...
            <div class="closed selector">
                <label class="checkbox-new">
                    <input type="checkbox" name="building_status">
...
<div class="max-width"><div class="row">
            ...
            <div>
                ...
                if($xplos[1] == 'min'){
                    $filterCompetion = Array(">PROPERTY_PRICE_FROM_EN"=>'1000000');
                }

                echo "<pre>"; print_r($filterCompetion); echo "</pre>";
