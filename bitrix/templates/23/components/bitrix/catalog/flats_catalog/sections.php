...
if($arResult["VARIABLES"]["SECTION_ID"] == 746 || $arResult['VARIABLES']['SECTION_CODE_PATH'] == 'condos' || $APPLICATION->GetCurDir() == '/'.strtolower(LANGUAGE_ID).'/condos/' || $APPLICATION->GetCurDir() == '/condos/'){
    //parse_url($_SERVER['REQUEST_URI']);
    //echo $_SERVER['REQUEST_URI'];

    if(($APPLICATION->GetCurDir() == '/'.strtolower(LANGUAGE_ID).'/condos/' || $APPLICATION->GetCurDir() == '/condos/')){
        $arResult["VARIABLES"]["SECTION_ID"] = 746;
    }
