...
if(LANGUAGE_ID == 'en'){
    $APPLICATION->SetPageProperty("title", 'Buy an apartment, 🏢 apartments for sale in the capital, ads and prices on Fodyo.com');
}else{
    $APPLICATION->SetPageProperty("title", 'Купить квартиру, 🏢 продажа квартир, объявления и цены на Fodyo.com');
}
