...
<div class="max-width"><div class="row">
            ...
            <div>
                ...
                //echo "<pre>"; print_r($xplos[1]); echo "</pre>";
                //$xplo = explode('-', $exploa[0]);
                //echo "<pre>"; print_r($xplo[1]); echo "</pre>";
                ...
                }elseif($xplos[0] == 'penthouses'){
                    $filterCompetion = Array(
                        "PROPERTY_TYPE_EN"=>'%Penthouse%'
                    );
                }else{
                    $filterCompetion = Array( array("PROPERTY_BEDS_EN" => $xplos[0], "PROPERTY_BEDS_RU" => $xplos[0]+1) );
                }
