	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="filter_section">
				<form class="fl-row">
					<select size="1" name="region-city">
						<option>Город/регион</option>
						<option>Москва</option>
					</select>
					<select size="1" name="type-building">
						<option>Тип</option>
					...
					<select size="1" name="price">
					 ...
					 <input id="submit_filter_btn" type="button" value="Искать" name="submit_filter">
				</form>
			</div>
			<div class="sort_section">
				<span class="textBlue sortTxt">Сортировать:</span>
				<span class="textOrange sortBtn">сначала дешевые</span>
				<span class="textOrange sortBtn">сначала дорогие</span>
				<span class="textOrange sortBtn">сначала новые</span>
			</div>
			<?
			...
			$intSectionID = $APPLICATION->IncludeComponent(
				...
				Array(
					...
					"FILTER_NAME" => "BEST_NEW_BUILDINGS",	// Имя массива со значениями фильтра для фильтрации элементов
