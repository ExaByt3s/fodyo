        ...
        )
        {
            if (Loader::includeModule('iblock'))
            {
                ...
                if ($arResult['IBLOCK_SECTION_ID'] > 0)
                {
                    ...
                    $urlDeleteSectionButton = str_replace('/usa', '', $section['SECTION_PAGE_URL']);
                    $urlDeleteSectionButton = str_replace('/russia', '', $urlDeleteSectionButton);
                }
                ...
                $returnUrl = str_replace('/usa', '', $returnUrl);
                
                $returnUrl = str_replace('/russia', '', $returnUrl);
