...
$APPLICATION->SetPageProperty('title', 'Selling real eastate in USA and abroad - more than '. $getCount .' ADs on Fodyo.com 🏘');
...
<div class="main-categories">
    <div class="flex-row">
        ...
        foreach ($getSections as $key => $value) {
            $value['SECTION_PAGE_URL'] = '/'.strtolower(LANGUAGE_ID).'-'.$isoLang.str_replace('/usa', '', $value['SECTION_PAGE_URL']);
            if($key == 0){
