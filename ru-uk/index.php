...
<div class="main-categories">
    <div class="flex-row">
        ...
        if (CModule::IncludeModule("iblock")){
            $getSections = GetAllSectionIn(4, 742, array('ACTIVE' => 'Y', 'UF_SHOW_MAIN_LIST' => '1', 'DEPTH_LEVEL' => '3'), array('ID', 'NAME', 'PICTURE', 'UF_NAME_RU', 'SECTION_PAGE_URL', 'DEPTH_LEVEL'));
                //echo "<pre>"; print_r($getSections); echo "</pre>";
        }
        $getSect = CIBlockSection::GetList(
            Array("SORT"=>"ASC"),
            Array('ID' => 742, 'IBLOCK_ID' => 4),
            false,
