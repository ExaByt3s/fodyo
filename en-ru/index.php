...
$APPLICATION->SetPageProperty('title', 'Selling real eastate in Russia and abroad - more than '. $getCount .' ADs on Fodyo.com 🏘');

$APPLICATION->SetPageProperty('description', 'Base of real estate ADs worldwide on Fodyo.com. Comfortable search ✅ Newbuildings, flats, townhouses ✅ ADs from owners, builders and real eastate agencies ✅ Real estate portal offers more than '. $getCount .' ADs');
...
<div class="main-categories">
    <div class="flex-row">
        ...
        foreach ($getSections as $key => $value) {
            $value['SECTION_PAGE_URL'] = '/'.strtolower(LANGUAGE_ID).'-'.$isoLang.str_replace('/russia', '', $value['SECTION_PAGE_URL']);
            if($key == 0){
