...
<div class="main-categories">
    <div class="flex-row">
        ...
        if (CModule::IncludeModule("iblock")){
            ...
            $getSections = GetAllSectionIn(4, 16, array('ACTIVE' => 'Y', 'DEPTH_LEVEL' => '2', "!PICTURE" => false), array('ID', 'NAME', 'PICTURE', 'UF_NAME_RU', 'SECTION_PAGE_URL', 'DEPTH_LEVEL'));
...
<?/*<div class="other-cities">
    <div class="max-width">
        ...
        <div class="flex-cities">
            ...
            $getSect = CIBlockSection::GetList(
                Array("SORT"=>"ASC"),
                Array('UF_SHOW_MAIN_LIST' => '1', 'IBLOCK_ID' => 4),
                false,
