...
$APPLICATION->SetPageProperty('title', 'Fodyo.com - selling real eastate in USA and abroad - more than '. $getCount .' ADs 🏘');

$APPLICATION->SetPageProperty('description', 'Fodyo.com - base of real estate ADs worldwide. Comfortable search ✅ Newbuildings, flats, cottages ✅ ADs from owners, builders and real eastate agencies ✅ Real estate portal '. $getCount .' offers more than () ADs');
...
<div class="main-categories">
    <div class="flex-row">
        ...
        if (CModule::IncludeModule("iblock")){
            ...
            $getSections = GetAllSectionIn(4, 17, array('ACTIVE' => 'Y', 'DEPTH_LEVEL' => '3', "!PICTURE" => false), array('ID', 'NAME', 'PICTURE', 'UF_NAME_RU', 'SECTION_PAGE_URL', 'DEPTH_LEVEL'));
        ...
        foreach ($getSections as $key => $value) {
            $value['SECTION_PAGE_URL'] = str_replace('developments/', "", $value['SECTION_PAGE_URL']);
            if($key == 0){
...
<div class="other-cities">
    <div class="max-width">
        ...
        <div class="flex-cities">
            ...
            $getSect = CIBlockSection::GetList(
                Array("SORT"=>"ASC"),
                Array('IBLOCK_ID' => 4, 'IBLOCK_SECTION_ID' => 17),
                false,
                array('ID', 'NAME', 'PICTURE', 'SECTION_PAGE_URL', 'DEPTH_LEVEL', 'UF_FLAG', 'UF_SHOW_MAIN_LIST', 'IBLOCK_SECTION_ID'),
                false
            );
    ...
    <div class="max-width">
        <div class="about-main">
            ...
            <div class="company-text">
                With Fodyo.com, you can find properties all over the world. New developments, townhouses, single-family homes, overseas real estate, and investment properties are now available on one convenient marketplace — Fodyo.com. You no longer need to search for real estate in different parts of the world using separate local databases, because we’ve created our own unique database with information about real estate around the world. Fodyo.com helps you save time when you’re searching for the property of your dreams.
            </div>
